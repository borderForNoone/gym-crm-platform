...
class FallbackControllerTest {
    ...
    void shouldReturn504ForTimeoutException() {
        ServerWebExchange exchange = createExchange(new TimeoutException("timeout"), "tx-timeout");
        ...
        assertEquals("Timeout: gym-core-service did not respond within 3s", body.error());
    ...
    void shouldReturn503ForConnectException() {
        ServerWebExchange exchange = createExchange(new ConnectException("connection refused"), "tx-connect");
        ...
        assertEquals("Connection error: Cannot connect to workload-service", body.error());
    ...
    void shouldReturn503ForUnknownException() {
        ServerWebExchange exchange = createExchange(new RuntimeException("unexpected"), "tx-runtime");
